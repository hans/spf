...
public abstract class AbstractSituatedTestingStatistics<SAMPLE, MR, LABEL, DI extends ILabeledDataItem<SAMPLE, LABEL>>
		implements ISituatedTestingStatistics<SAMPLE, MR, LABEL, DI> {

	private final String				metricName;
	private final String				prefix;
	protected final IStatistics<SAMPLE>	stats;

	public AbstractSituatedTestingStatistics(String prefix, String metricName,
